  ...
  return (
    <div className="coaching_mainContainer" ref={sectionRef}>
      <div
        className={`coaching_scrollContainer ${isVisible ? "animate-in" : ""}`}
      >
        <div className="coaching_innerWrapper">

          {/* ── Section Header ── */}
          <div className="coaching_header">
            <h2 className="section-title">
              Why
              <span className="title-highlight"> Choose Us</span>
            </h2>
            <div className="title-underline"></div>
            <p className="coaching_intro">
              Pre-Engineered Buildings that deliver speed, efficiency, and
              sustainability — built to scale with your ambitions.
            </p>
          </div>
